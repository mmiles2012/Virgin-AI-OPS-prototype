...
`]);
  ...
  // Flight plan routes now handled by modular router
  ...
  // OpenDataSoft routes removed - using local database search only

  // OpenDataSoft statistics and airlines routes removed - using local database only
