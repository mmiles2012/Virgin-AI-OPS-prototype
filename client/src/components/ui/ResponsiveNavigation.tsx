...
const ResponsiveNavigation: React.FC<ResponsiveNavigationProps> = ({
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <HideOnMobile>
        <nav className="bg-slate-900/95 backdrop-blur-sm border-r border-slate-700 w-64 min-h-screen p-4">
          {/* Brand */}
      ...
      <ShowOnMobile>
        {/* Mobile Header */}
        <div className="bg-slate-900/95 backdrop-blur-sm border-b border-slate-700 px-4 py-3 flex items-center justify-between sticky top-0 z-50">
        ...
        {/* Mobile Menu Drawer */}
        <div className={cn(
          'fixed top-0 right-0 h-full w-80 max-w-[80vw] bg-slate-900 transform transition-transform duration-300 z-50',
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-sm border-t border-slate-700 px-2 py-2 z-40">
...
export const ExampleNavigation: React.FC = () => {
  ...
  return (
    <ResponsiveNavigation
      ...
      brand={{
        name: 'AINO Platform',
        logo: <Plane className="h-6 w-6 text-orange-500" />
      }}
    />
  );
};
