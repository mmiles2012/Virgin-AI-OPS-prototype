...
// Earth Globe Component with Realistic Material Shading
const EarthGlobe: React.FC = () => {
  ...
  return (
    <group>
      {/* Main Earth sphere with realistic shading */}
      ...
      {/* Continental land masses as overlays */}
