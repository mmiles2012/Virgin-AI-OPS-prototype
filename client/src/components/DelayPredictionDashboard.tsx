  ...
  return (
    <div className="h-screen w-full bg-gray-50 overflow-y-auto">
      <div className="max-w-7xl mx-auto p-6">
        ...
        {/* Tab Navigation */}
        <div className="mb-6">
          <div className="border-b border-va-grey bg-va-white rounded-t-lg">
            <nav className="flex space-x-2 px-2">
              {[
                ...
                <button
                  ...
                  className={`py-2 px-4 rounded-t-md font-medium text-sm transition-colors ${
                    activeTab === tab.id
                      ? 'border-b-2 border-va-red-primary text-va-red-primary bg-va-white'
                      : 'border-b-2 border-transparent text-va-cosmic-grey bg-surface-tertiary/20 hover:text-va-red-primary hover:bg-va-white'
                  }`}
                >
                  {tab.label}
                </button>
