          ...
          {isNavigationCollapsed ? (
            ...
            <div className="flex justify-center">
              <button
                ...
                className="navigation-toggle bg-va-red-primary text-foreground hover:bg-va-red-heritage w-8 h-8 flex items-center justify-center rounded-md transition-all duration-200 cursor-pointer"
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="navigation-toggle bg-va-red-primary text-foreground hover:bg-va-red-heritage flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-md transition-all duration-200 cursor-pointer"
