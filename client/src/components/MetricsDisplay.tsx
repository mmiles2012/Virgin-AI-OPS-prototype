        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="text-center">
              ...
              <div className="text-2xl font-mono text-aero-green-safe">{fuelEfficiency.toFixed(0)}%</div>
            </div>
            <div className="text-center">
              <div className="text-blue-300">Flight Score</div>
              <div className="text-2xl font-mono text-aero-blue-primary">{score}/100</div>
            </div>
          </div>
          ...
          <div className="space-y-3 border-t border-blue-500 pt-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <div className="text-foreground font-mono">{decisionsMade}</div>
              </div>
              <div>
                <div className="text-blue-300">Response Time</div>
                <div className="text-foreground font-mono">{timeToDecision.toFixed(1)}s</div>
              </div>
            </div>
        ...
        <div className="space-y-3 border-t border-blue-500 pt-3">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-foreground">${(fuelRemaining * 0.02).toFixed(0)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-blue-300">Time Delay</span>
              <span className="text-foreground">${currentScenario ? '15,000' : '0'}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-blue-300">Passenger Impact</span>
              <span className="text-foreground">${currentScenario ? '25,000' : '0'}</span>
            </div>
            <div className="flex justify-between font-medium border-t border-border pt-1">
              <span className="text-blue-300">Total Cost</span>
              <span className="text-aero-amber-caution">
        ...
        <div className="space-y-3 border-t border-blue-500 pt-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="text-center border border-border rounded p-2">
              ...
              <div className="text-foreground font-mono">{altitude.toFixed(0)} ft</div>
            </div>
            <div className="text-center border border-border rounded p-2">
              <div className="text-blue-300">Speed</div>
              <div className="text-foreground font-mono">{airspeed.toFixed(0)} kts</div>
            </div>
            <div className="text-center border border-border rounded p-2">
              <div className="text-blue-300">Fuel</div>
              <div className="text-foreground font-mono">{calculateFuelPercentage('A350-1000', 68)}%</div>
            </div>
            <div className="text-center border border-border rounded p-2">
              <div className="text-blue-300">Range</div>
              <div className="text-foreground font-mono">{(fuelRemaining / 3.5).toFixed(0)} nm</div>
            </div>
          </div>
        </div>

        {/* Performance Rating */}
        <div className="bg-aero-green-safe/10 border border-green-500 rounded p-3">
          <div className="text-center">
