...
export const majorAirports: Airport[] = [
  ...
  // Virgin Atlantic Strategic Airports and Emergency Diversion Points
  {
    icao: 'VOBL',
    iata: 'BLR',
  ...
  },
  {
    ...
    elevation: 3557,
    timezone: 'America/Edmonton',
    runways: ['07/25', '11/29', '16/34', '17L/35R', '17R/35L'],
    category: 'major'
  },
  {
    icao: 'BIKF',
